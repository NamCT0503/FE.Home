                    ...
                    <div className="widget_area">
                        <div className="col-md-3">
                            <div className="widget_item widget_about">
                                ...
                                <p className="m-top-20">Lorem ipsum dolor sit amet consec tetur adipiscing elit 
                        ...
                        <div className="col-md-3">
                            <div className="widget_item widget_service sm-m-top-50">
                                ...
                                <ul className="m-top-20">
                                    ...
                                    <li className="m-top-20"><a href=""><i className="fa fa-angle-right"></i> E- Commerce</a></li>
